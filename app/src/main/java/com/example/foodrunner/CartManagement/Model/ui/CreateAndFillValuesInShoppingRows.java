...
public class CreateAndFillValuesInShoppingRows  extends BaseExpandableListAdapter {

    private Context context;
    private ArrayList<ExpandShopGroup> groups;

    public CreateAndFillValuesInShoppingRows(Context context, ArrayList<ExpandShopGroup> groups) {
                ...
                switch (menuItem.getItemId())
                {
                    case R.id.deleteRow:
                        FirebaseDatabase.getInstance().getReference("shopping")
                                .child(CartMainActivity.getSubscriberId(anchor.getContext())).child(shoppingId).removeValue();
                        break;
                }
                return true;
            }

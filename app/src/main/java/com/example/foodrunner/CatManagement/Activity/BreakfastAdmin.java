...
public class BreakfastAdmin extends AppCompatActivity implements ImageAdapter.OnItemClickListener{

    private RecyclerView mRecyclerView;
    private ImageAdapter mAdapter;
    private Button btnBAdmin,btnLAdmin,btnDAdmin;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_breakfast_admin);
        ...
        mAdapter = new ImageAdapter(BreakfastAdmin.this,productsList);
        mRecyclerView.setAdapter(mAdapter);
        mAdapter.setOnItemClickListener(BreakfastAdmin.this);

        mStorage = FirebaseStorage.getInstance();
        dbRef = FirebaseDatabase.getInstance().getReference("Products");
        dbRef1=FirebaseDatabase.getInstance().getReference("Products").orderByChild("category").equalTo("Breakfast");


        btnBAdmin=findViewById(R.id.btnBreakfast);
        btnLAdmin=findViewById(R.id.btnLunch);
        btnDAdmin=findViewById(R.id.btnDinner);

        btnBAdmin.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(BreakfastAdmin.this,BreakfastAdmin.class);
        ...
        btnLAdmin.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(BreakfastAdmin.this,LunchAdmin.class);
                startActivity(intent);
            }
        });

        btnDAdmin.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(BreakfastAdmin.this,DinnerAdmin.class);
                startActivity(intent);
            }
        });
        ...
        mDBListener = dbRef1.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(BreakfastAdmin.this, error.getMessage() , Toast.LENGTH_SHORT).show();
                mProgressCircle.setVisibility(View.INVISIBLE);
            }
        });
    }
    ...
    public void onDeleteClick(int position) {
        ...
        imageRef.delete().addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void aVoid) {
                ...
                Toast.makeText(BreakfastAdmin.this, "Product Deleted", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    protected void onDestroy() {
        super.onDestroy();
        dbRef1.removeEventListener(mDBListener);
    }

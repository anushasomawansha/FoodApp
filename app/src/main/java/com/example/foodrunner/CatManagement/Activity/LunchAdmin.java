...
public class LunchAdmin extends AppCompatActivity implements ImageAdapter.OnItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new ImageAdapter(LunchAdmin.this,productsList);
        mRecyclerView.setAdapter(mAdapter);
        mAdapter.setOnItemClickListener(LunchAdmin.this);
        ...
        btnBAdmin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(LunchAdmin.this,BreakfastAdmin.class);
        ...
        btnLAdmin.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(LunchAdmin.this,LunchAdmin.class);
                startActivity(intent);
            }
        });
        ...
        btnDAdmin.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(LunchAdmin.this,DinnerAdmin.class);
                startActivity(intent);
            }
        });
        ...
        dbRef1=FirebaseDatabase.getInstance().getReference("Products").orderByChild("category").equalTo("Lunch");
        ...
        mDBListener = dbRef1.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(LunchAdmin.this, error.getMessage() , Toast.LENGTH_SHORT).show();
                mProgressCircle.setVisibility(View.INVISIBLE);
            }
        });
    }
    ...
    public void onDeleteClick(int position) {
        ...
        imageRef.delete().addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void aVoid) {
                ...
                Toast.makeText(LunchAdmin.this, "Product Deleted", Toast.LENGTH_SHORT).show();
            }
        });
    }

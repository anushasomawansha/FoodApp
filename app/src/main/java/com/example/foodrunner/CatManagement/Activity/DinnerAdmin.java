...
public class DinnerAdmin extends AppCompatActivity implements ImageAdapter.OnItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new ImageAdapter(DinnerAdmin.this,productsList);
        mRecyclerView.setAdapter(mAdapter);
        mAdapter.setOnItemClickListener(DinnerAdmin.this);
        ...
        btnBAdmin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(DinnerAdmin.this,BreakfastAdmin.class);
        ...
        btnLAdmin.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(DinnerAdmin.this,LunchAdmin.class);
                startActivity(intent);
            }
        });
        ...
        btnDAdmin.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(DinnerAdmin.this,DinnerAdmin.class);
                startActivity(intent);
            }
        });
        ...
        dbRef1=FirebaseDatabase.getInstance().getReference("Products").orderByChild("category").equalTo("Dinner");
        ...
        mDBListener = dbRef1.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(DinnerAdmin.this, error.getMessage() , Toast.LENGTH_SHORT).show();
                mProgressCircle.setVisibility(View.INVISIBLE);
            }
        });
    }
    ...
    public void onDeleteClick(int position) {
        ...
        imageRef.delete().addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void aVoid) {
                ...
                Toast.makeText(DinnerAdmin.this, "Product Deleted", Toast.LENGTH_SHORT).show();
            }
        });
    }
